...
tabs = st.tabs(["Review", "Input Metrics", "UTM Campaign", "Bottom of Funnel", "Add-on Products", "Webinars", "Input", "Marketing Performance"])
...
with tabs[7]:
    ...
    if missing_cols:
        ...
        top_n = st.slider("Show top N campaigns by revenue", 5, min(50, max(5, len(camp_f))), value=min(15, max(5, len(camp_f))), key="mp_top_n")
